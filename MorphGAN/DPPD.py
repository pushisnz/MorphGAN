...
from MLCCA import CoordinateAttentionResnet
import random
...
class Generator(nn.Module):
    def __init__(self, ngf=64, nz=100, nc=3, im_size=1024):
        ...
        self.se_64 = CoordinateAttentionResnet(nfc[4], nfc[64])
        self.se_128 = CoordinateAttentionResnet(nfc[8], nfc[128])
        self.se_256 = CoordinateAttentionResnet(nfc[16], nfc[256])
        ...
        self.decoder_small = SimpleDecoder(nfc[8], nc)

        if im_size > 256:
            self.feat_512 = UpBlockComp(nfc[256], nfc[512])
            self.se_512 = CoordinateAttentionResnet(nfc[32], nfc[512])
        if im_size > 512:
    ...
    def forward(self, input):
        ...
        if self.im_size == 512:
            return [self.to_big(feat_512), self.to_128(feat_128)], None, None
        ...
        return [im_1024, im_128], None, None
...
class Discriminator(nn.Module):
    def __init__(self, ndf=64, nc=3, im_size=512):
        ...
        # self.se_2_16 = CoordinateAttentionResnet_D(nfc[512], nfc[64])
        # self.se_4_32 = CoordinateAttentionResnet_D(nfc[256], nfc[32])
        # self.se_8_64 = CoordinateAttentionResnet_D(nfc[128], nfc[16])
        # 小图片处理路径
